...
var sandMassgae = function sandMassgae(massage) {
  var msg = {
    name: name,
    massage: massage
  };
...
var appundMassage = function appundMassage(msg, type) {
  var newDev = document.createElement('div');
  newDev.classList.add(type, "chat-box");
  var markup = "\n    <h4> ".concat(msg.name, "</h4>\n    <p>").concat(msg.massage, "</p>     \n    ");
...
socket.on("typing", function (data) {
  typing.innerHTML = "<b>".concat(data.name, "</b> is typing...");
  typingStatusUpdate(function () {
    typing.innerHTML = "";
  }, 1000);
});
var typingTime = null;
var typingStatusUpdate = function typingStatusUpdate(func, time) {
  if (typingTime) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksocket"] = self["webpackChunksocket"] || [];
